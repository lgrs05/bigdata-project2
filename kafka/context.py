...
class OffsetCommitContext(object):
    ...
    def handle_out_of_range(self):
        """
        Handle output of range condition by seeking to the beginning of valid
        ranges.

        This assumes that an output of range doesn't happen by seeking past the end
        of valid ranges -- which is far less likely.
        """
        self.logger.info("Seeking beginning of partition on output of range error")
