...
class ConsumerRebalanceListener(object):
    ...
    Another use is flushing output any kind of cache of intermediate results the
    ...
    a running tally of actions per user and only flush these output to a remote
